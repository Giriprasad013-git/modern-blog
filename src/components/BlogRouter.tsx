  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        {/* CMS redirect to subdomain */}
        <Route 
          path="/cms" 
          element={
            <div className="flex flex-col items-center justify-center min-h-screen p-4 text-center">
              <h1 className="text-3xl font-bold mb-4">CMS Access</h1>
              <p className="mb-8">The CMS is available at <a href="https://cms.fastandfacts.com" className="text-blue-600 hover:underline">cms.fastandfacts.com</a></p>
              <a href="https://cms.fastandfacts.com" className="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors">
                Go to CMS
              </a>
            </div>
          } 

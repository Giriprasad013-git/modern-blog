...
import { Star, StarOff, Calendar, Eye, BookOpen } from 'lucide-react';
...
const ReadingListPage = () => {
  ...
  const { preferences, removeFromReadingList } = useUserPreferences();

  // Filter posts that are in reading list
  const readingListPosts = allPosts.filter(post => 
    preferences.readingList.includes(post.slug)
  );

  const handleRemoveFromReadingList = (slug: string) => {
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            Articles you've marked for focused reading ({readingListPosts.length} items)
          </p>
        </div>

        {readingListPosts.length === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Add articles to your reading list for focused reading sessions.
            </p>
            <Button asChild>
                    ...
                    <div className="flex items-start justify-between gap-4 mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => handleRemoveFromReadingList(post.slug)}
